...
//==============================================================================
/*
    extern uint8_t         bl_tid_onoff;          // TID for gonoff messages
    extern BL_gonoff_state bl_gonoff_state0;  // onoff state for GONOFF_CLI0

    BL_model *bl_gonoff_srv_add(BL_element *pel, BL_pub *ppub, BL_gonoff_state *pud);
    BL_model *bl_gonoff_cli_add(BL_element *pel, BL_pub *ppub, BL_gonoff_state *pud);
*/
//==============================================================================
// opcode map table
//==============================================================================

    extern const BL_ocmap bl_gonoff_srv_op[];
    extern const BL_ocmap bl_gonoff_cli_op[];

//==============================================================================
// publish generic onoff state
//==============================================================================

    void bl_tx_gonoff(BL_model *model);

//==============================================================================
// send generic onoff message
//==============================================================================

    int bl_tx_gonoff_set(BL_model *pmod, BL_u8 on, uint8_t tid, uint8_t tt, uint8_t d);
    int bl_tx_gonoff_let(BL_model *pmod, uint8_t on, uint8_t tid, uint8_t tt, uint8_t d);
    int bl_tx_gonoff_get(BL_model *pmod);
