...
//==============================================================================
  ...
  #define LOG                     LOG_CORE
  #define LOGO(lvl,col,o,val)     LOGO_CORE(lvl,col"xyz:",o,val)
...
//==============================================================================
// helper: save last lightness states
//==============================================================================
  ...
  static void save_lightness_last_state(void)
  {
  	...
  	LOG(5,"Lightness Last values have been saved !!");
  }

//==============================================================================
// helper: save last target states
//==============================================================================
...
//==============================================================================
  ...
  int ps_settings_init(void)
  {
  	...
  	if (err)
    {
  		LOG(5,"settings_subsys_init failed (err %d)", err);
  		return err;
  	}
  	...
  	if (err)
    {
  		LOG(5,"ps_settings_register failed (err %d)", err);
  		return err;
  	}
